...
#include "capella_ros_service_interfaces/msg/detail/irtemperature_data__rosidl_typesupport_fastrtps_c.h"
...
using _IrtemperatureData__ros_msg_type = capella_ros_service_interfaces__msg__IrtemperatureData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IrtemperatureData__ros_msg_type * ros_message = static_cast<const _IrtemperatureData__ros_msg_type *>(untyped_ros_message);
  // Field name: irtemperature
  {
  ...
  void * untyped_ros_message)
{
  ...
  _IrtemperatureData__ros_msg_type * ros_message = static_cast<_IrtemperatureData__ros_msg_type *>(untyped_ros_message);
  // Field name: irtemperature
  {
    cdr >> ros_message->irtemperature;
  }
...
static uint32_t _IrtemperatureData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_capella_ros_service_interfaces__msg__IrtemperatureData(
...
static size_t _IrtemperatureData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_capella_ros_service_interfaces__msg__IrtemperatureData(
...
static message_type_support_callbacks_t __callbacks_IrtemperatureData = {
...
static rosidl_message_type_support_t _IrtemperatureData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IrtemperatureData,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_service_interfaces, msg, IrtemperatureData)() {
  return &_IrtemperatureData__type_support;
}
