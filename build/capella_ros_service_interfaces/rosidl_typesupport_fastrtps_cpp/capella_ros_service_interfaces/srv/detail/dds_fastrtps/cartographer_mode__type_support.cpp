...
#include "capella_ros_service_interfaces/srv/detail/cartographer_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const capella_ros_service_interfaces::srv::CartographerMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_service_interfaces::srv::CartographerMode_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CartographerMode_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const capella_ros_service_interfaces::srv::CartographerMode_Request *>(
...
static size_t _CartographerMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CartographerMode_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CartographerMode_Request__callbacks = {
...
static rosidl_message_type_support_t _CartographerMode_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartographerMode_Request__callbacks,
...
{
  return &capella_ros_service_interfaces::srv::typesupport_fastrtps_cpp::_CartographerMode_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const capella_ros_service_interfaces::srv::CartographerMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<capella_ros_service_interfaces::srv::CartographerMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CartographerMode_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const capella_ros_service_interfaces::srv::CartographerMode_Response *>(
...
static size_t _CartographerMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CartographerMode_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CartographerMode_Response__callbacks = {
  "capella_ros_service_interfaces::srv",
...
static rosidl_message_type_support_t _CartographerMode_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartographerMode_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &capella_ros_service_interfaces::srv::typesupport_fastrtps_cpp::_CartographerMode_Response__handle;
}
...
static service_type_support_callbacks_t _CartographerMode__callbacks = {
  "capella_ros_service_interfaces::srv",
  "CartographerMode",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_service_interfaces, srv, CartographerMode_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_service_interfaces, srv, CartographerMode_Response)(),
...
static rosidl_service_type_support_t _CartographerMode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartographerMode__callbacks,
...
{
  return &capella_ros_service_interfaces::srv::typesupport_fastrtps_cpp::_CartographerMode__handle;
}
