...
capella_ros_service_interfaces__msg__MissionStatus__create()
{
  ...
  capella_ros_service_interfaces__msg__MissionStatus * msg = (capella_ros_service_interfaces__msg__MissionStatus *)allocator.allocate(sizeof(capella_ros_service_interfaces__msg__MissionStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(capella_ros_service_interfaces__msg__MissionStatus));
  bool success = capella_ros_service_interfaces__msg__MissionStatus__init(msg);
  if (!success) {
...
capella_ros_service_interfaces__msg__MissionStatus__destroy(capella_ros_service_interfaces__msg__MissionStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    capella_ros_service_interfaces__msg__MissionStatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
capella_ros_service_interfaces__msg__MissionStatus__Sequence__init(capella_ros_service_interfaces__msg__MissionStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  capella_ros_service_interfaces__msg__MissionStatus * data = NULL;

  if (size) {
    data = (capella_ros_service_interfaces__msg__MissionStatus *)allocator.zero_allocate(size, sizeof(capella_ros_service_interfaces__msg__MissionStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = capella_ros_service_interfaces__msg__MissionStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        capella_ros_service_interfaces__msg__MissionStatus__fini(&data[i - 1]);
      }
...
capella_ros_service_interfaces__msg__MissionStatus__Sequence__fini(capella_ros_service_interfaces__msg__MissionStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      capella_ros_service_interfaces__msg__MissionStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  capella_ros_service_interfaces__msg__MissionStatus__Sequence * array = (capella_ros_service_interfaces__msg__MissionStatus__Sequence *)allocator.allocate(sizeof(capella_ros_service_interfaces__msg__MissionStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = capella_ros_service_interfaces__msg__MissionStatus__Sequence__init(array, size);
  if (!success) {
...
capella_ros_service_interfaces__msg__MissionStatus__Sequence__destroy(capella_ros_service_interfaces__msg__MissionStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    capella_ros_service_interfaces__msg__MissionStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
capella_ros_service_interfaces__msg__MissionStatus__Sequence__are_equal(const capella_ros_service_interfaces__msg__MissionStatus__Sequence * lhs, const capella_ros_service_interfaces__msg__MissionStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!capella_ros_service_interfaces__msg__MissionStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  capella_ros_service_interfaces__msg__MissionStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(capella_ros_service_interfaces__msg__MissionStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    capella_ros_service_interfaces__msg__MissionStatus * data =
      (capella_ros_service_interfaces__msg__MissionStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!capella_ros_service_interfaces__msg__MissionStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          capella_ros_service_interfaces__msg__MissionStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!capella_ros_service_interfaces__msg__MissionStatus__copy(
