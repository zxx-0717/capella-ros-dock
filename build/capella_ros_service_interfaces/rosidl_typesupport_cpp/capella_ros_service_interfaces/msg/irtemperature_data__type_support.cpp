...
static const _IrtemperatureData_type_support_symbol_names_t _IrtemperatureData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_service_interfaces, msg, IrtemperatureData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, capella_ros_service_interfaces, msg, IrtemperatureData)),
  }
};
...
{
  return &::capella_ros_service_interfaces::msg::rosidl_typesupport_cpp::IrtemperatureData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, capella_ros_service_interfaces, msg, IrtemperatureData)() {
  return get_message_type_support_handle<capella_ros_service_interfaces::msg::IrtemperatureData>();
}
