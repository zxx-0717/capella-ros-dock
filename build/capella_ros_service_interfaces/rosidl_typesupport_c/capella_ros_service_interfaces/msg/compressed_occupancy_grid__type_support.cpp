...
static const _CompressedOccupancyGrid_type_support_symbol_names_t _CompressedOccupancyGrid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_service_interfaces, msg, CompressedOccupancyGrid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capella_ros_service_interfaces, msg, CompressedOccupancyGrid)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, capella_ros_service_interfaces, msg, CompressedOccupancyGrid)() {
  return &::capella_ros_service_interfaces::msg::rosidl_typesupport_c::CompressedOccupancyGrid_message_type_support_handle;
}
