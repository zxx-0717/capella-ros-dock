...
static const _SwitchMode_Request_type_support_symbol_names_t _SwitchMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_service_interfaces, srv, SwitchMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capella_ros_service_interfaces, srv, SwitchMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, capella_ros_service_interfaces, srv, SwitchMode_Request)() {
  return &::capella_ros_service_interfaces::srv::rosidl_typesupport_c::SwitchMode_Request_message_type_support_handle;
}
...
static const _SwitchMode_Response_type_support_symbol_names_t _SwitchMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_service_interfaces, srv, SwitchMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capella_ros_service_interfaces, srv, SwitchMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, capella_ros_service_interfaces, srv, SwitchMode_Response)() {
  return &::capella_ros_service_interfaces::srv::rosidl_typesupport_c::SwitchMode_Response_message_type_support_handle;
}
...
static const _SwitchMode_type_support_symbol_names_t _SwitchMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_service_interfaces, srv, SwitchMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, capella_ros_service_interfaces, srv, SwitchMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, capella_ros_service_interfaces, srv, SwitchMode)() {
  return &::capella_ros_service_interfaces::srv::rosidl_typesupport_c::SwitchMode_service_type_support_handle;
}
