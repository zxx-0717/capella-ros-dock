...
bool capella_ros_service_interfaces__msg__compressed_occupancy_grid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("capella_ros_service_interfaces.msg._compressed_occupancy_grid.CompressedOccupancyGrid", full_classname_dest, 85) == 0);
  }
  capella_ros_service_interfaces__msg__CompressedOccupancyGrid * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CompressedOccupancyGrid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("capella_ros_service_interfaces.msg._compressed_occupancy_grid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CompressedOccupancyGrid");
