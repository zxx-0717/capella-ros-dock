...
class Metaclass_MissionStatus(type):
    ...
    __constants = {
        ...
        'MISSION_STATUS_CARTO': 1,
        'MISSION_STATUS_NAV': 2,
        'MISSION_STATUS_INFRARED': 3,
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'capella_ros_service_interfaces.msg.MissionStatus')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'MISSION_STATUS_IDLE': cls.__constants['MISSION_STATUS_IDLE'],
            'MISSION_STATUS_CARTO': cls.__constants['MISSION_STATUS_CARTO'],
            'MISSION_STATUS_NAV': cls.__constants['MISSION_STATUS_NAV'],
            'MISSION_STATUS_INFRARED': cls.__constants['MISSION_STATUS_INFRARED'],
        }

    @property
    def MISSION_STATUS_IDLE(self):
        """Message constant 'MISSION_STATUS_IDLE'."""
        return Metaclass_MissionStatus.__constants['MISSION_STATUS_IDLE']

    @property
    def MISSION_STATUS_CARTO(self):
        """Message constant 'MISSION_STATUS_CARTO'."""
        return Metaclass_MissionStatus.__constants['MISSION_STATUS_CARTO']

    @property
    def MISSION_STATUS_NAV(self):
        """Message constant 'MISSION_STATUS_NAV'."""
        return Metaclass_MissionStatus.__constants['MISSION_STATUS_NAV']

    @property
    def MISSION_STATUS_INFRARED(self):
        """Message constant 'MISSION_STATUS_INFRARED'."""
        return Metaclass_MissionStatus.__constants['MISSION_STATUS_INFRARED']
...
class MissionStatus(metaclass=Metaclass_MissionStatus):
    ...
    Constants:
      MISSION_STATUS_IDLE
      MISSION_STATUS_CARTO
      MISSION_STATUS_NAV
      MISSION_STATUS_INFRARED
    """
