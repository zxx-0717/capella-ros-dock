...
#include "capella_ros_dock_msgs/msg/detail/hazard_detection_vector__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const capella_ros_dock_msgs::msg::HazardDetection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  capella_ros_dock_msgs::msg::HazardDetection &);
size_t get_serialized_size(
  const capella_ros_dock_msgs::msg::HazardDetection &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const capella_ros_dock_msgs::msg::HazardDetectionVector & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  capella_ros_dock_msgs::msg::HazardDetectionVector & ros_message)
{
  // Member: header
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_HazardDetection(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const capella_ros_dock_msgs::msg::HazardDetectionVector *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_dock_msgs::msg::HazardDetectionVector *>(
    untyped_ros_message);
...
{
  return &capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::_HazardDetectionVector__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_dock_msgs, msg, HazardDetectionVector)() {
  return &capella_ros_dock_msgs::msg::typesupport_fastrtps_cpp::_HazardDetectionVector__handle;
}
