...
#include "capella_ros_dock_msgs/srv/detail/e_stop__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const capella_ros_dock_msgs::srv::EStop_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  capella_ros_dock_msgs::srv::EStop_Request & ros_message)
{
  // Member: e_stop_on
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const capella_ros_dock_msgs::srv::EStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_dock_msgs::srv::EStop_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_capella_ros_dock_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<capella_ros_dock_msgs::srv::EStop_Request>()
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_dock_msgs, srv, EStop_Request)() {
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_capella_ros_dock_msgs
cdr_serialize(
  const capella_ros_dock_msgs::srv::EStop_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  capella_ros_dock_msgs::srv::EStop_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const capella_ros_dock_msgs::srv::EStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<capella_ros_dock_msgs::srv::EStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_dock_msgs, srv, EStop_Response)() {
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop_Response__handle;
}
...
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_dock_msgs, srv, EStop)() {
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_EStop__handle;
}
