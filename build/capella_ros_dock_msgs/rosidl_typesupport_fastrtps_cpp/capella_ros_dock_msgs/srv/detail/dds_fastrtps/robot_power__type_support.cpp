...
#include "capella_ros_dock_msgs/srv/detail/robot_power__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const capella_ros_dock_msgs::srv::RobotPower_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_dock_msgs::srv::RobotPower_Request *>(
    untyped_ros_message);
...
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_RobotPower_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const capella_ros_dock_msgs::srv::RobotPower_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<capella_ros_dock_msgs::srv::RobotPower_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_RobotPower_Response__handle;
}
...
{
  return &capella_ros_dock_msgs::srv::typesupport_fastrtps_cpp::_RobotPower__handle;
}
