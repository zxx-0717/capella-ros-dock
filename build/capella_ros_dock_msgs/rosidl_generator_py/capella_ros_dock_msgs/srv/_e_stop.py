...
class Metaclass_EStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'capella_ros_dock_msgs.srv.EStop')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from capella_ros_dock_msgs.srv import _e_stop
...
class EStop(metaclass=Metaclass_EStop):
    from capella_ros_dock_msgs.srv._e_stop import EStop_Request as Request
    from capella_ros_dock_msgs.srv._e_stop import EStop_Response as Response
