...
{
  new (message_memory) capella_ros_dock_msgs::msg::HazardDetectionVector(_init);
}

void HazardDetectionVector_fini_function(void * message_memory)
{
  auto typed_message = static_cast<capella_ros_dock_msgs::msg::HazardDetectionVector *>(message_memory);
  typed_message->~HazardDetectionVector();
}

size_t size_function__HazardDetectionVector__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<capella_ros_dock_msgs::msg::HazardDetection> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<capella_ros_dock_msgs::msg::HazardDetection> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<capella_ros_dock_msgs::msg::HazardDetection> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const capella_ros_dock_msgs::msg::HazardDetection *>(
    get_const_function__HazardDetectionVector__detections(untyped_member, index));
  auto & value = *reinterpret_cast<capella_ros_dock_msgs::msg::HazardDetection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<capella_ros_dock_msgs::msg::HazardDetection *>(
    get_function__HazardDetectionVector__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const capella_ros_dock_msgs::msg::HazardDetection *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HazardDetectionVector_message_member_array[2] = {
  {
    ...
    offsetof(capella_ros_dock_msgs::msg::HazardDetectionVector, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<capella_ros_dock_msgs::msg::HazardDetection>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_dock_msgs::msg::HazardDetectionVector, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HazardDetectionVector_message_members = {
  ...
  2,  // number of fields
  sizeof(capella_ros_dock_msgs::msg::HazardDetectionVector),
...
get_message_type_support_handle<capella_ros_dock_msgs::msg::HazardDetectionVector>()
{
  return &::capella_ros_dock_msgs::msg::rosidl_typesupport_introspection_cpp::HazardDetectionVector_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, capella_ros_dock_msgs, msg, HazardDetectionVector)() {
  return &::capella_ros_dock_msgs::msg::rosidl_typesupport_introspection_cpp::HazardDetectionVector_message_type_support_handle;
}
