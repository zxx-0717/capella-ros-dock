...
#ifndef CAPELLA_ROS_DOCK_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
#define CAPELLA_ROS_DOCK_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
 ...
 * calls
 * capella_ros_dock_msgs__srv__RobotPower_Request__init().
...
/**
 * It calls
 * capella_ros_dock_msgs__srv__RobotPower_Request__fini()
 ...
 * capella_ros_dock_msgs__srv__RobotPower_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * capella_ros_dock_msgs__srv__RobotPower_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * capella_ros_dock_msgs__srv__RobotPower_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_capella_ros_dock_msgs
...
/**
 * It calls
 * capella_ros_dock_msgs__srv__RobotPower_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_capella_ros_dock_msgs
...
/**
 * It allocates the memory for the array and calls
 * capella_ros_dock_msgs__srv__RobotPower_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_capella_ros_dock_msgs
...
/**
 * It calls
 * capella_ros_dock_msgs__srv__RobotPower_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAPELLA_ROS_DOCK_MSGS__SRV__DETAIL__ROBOT_POWER__FUNCTIONS_H_
