...
#include "capella_ros_msg/msg/detail/battery__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const capella_ros_msg::msg::Battery & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  capella_ros_msg::msg::Battery & ros_message)
{
  // Member: battery
  cdr >> ros_message.battery;
...
{
  auto typed_message =
    static_cast<const capella_ros_msg::msg::Battery *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_msg::msg::Battery *>(
    untyped_ros_message);
...
{
  return &capella_ros_msg::msg::typesupport_fastrtps_cpp::_Battery__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_msg, msg, Battery)() {
  return &capella_ros_msg::msg::typesupport_fastrtps_cpp::_Battery__handle;
}
