...
#include "capella_ros_msg/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const capella_ros_msg::msg::PID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  capella_ros_msg::msg::PID & ros_message)
{
  // Member: p
  cdr >> ros_message.p;
...
{
  auto typed_message =
    static_cast<const capella_ros_msg::msg::PID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_msg::msg::PID *>(
    untyped_ros_message);
...
{
  return &capella_ros_msg::msg::typesupport_fastrtps_cpp::_PID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, capella_ros_msg, msg, PID)() {
  return &capella_ros_msg::msg::typesupport_fastrtps_cpp::_PID__handle;
}
