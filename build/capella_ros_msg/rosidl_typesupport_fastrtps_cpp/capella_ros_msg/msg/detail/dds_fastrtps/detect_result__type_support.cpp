...
#include "capella_ros_msg/msg/detail/detect_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const capella_ros_msg::msg::SingleDetector &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  capella_ros_msg::msg::SingleDetector &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
  {
    ...
    for (size_t i = 0; i < size; i++) {
      capella_ros_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  capella_ros_msg::msg::DetectResult & ros_message)
{
  // Member: result
  {
    ...
    for (size_t i = 0; i < size; i++) {
      capella_ros_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        capella_ros_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        capella_ros_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_SingleDetector(
...
{
  auto typed_message =
    static_cast<const capella_ros_msg::msg::DetectResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<capella_ros_msg::msg::DetectResult *>(
    untyped_ros_message);
...
static size_t _DetectResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectResult(full_bounded, is_plain, 0);
...
{
  return &capella_ros_msg::msg::typesupport_fastrtps_cpp::_DetectResult__handle;
}
