...
#include "capella_ros_msg/msg/detail/velocities__rosidl_typesupport_fastrtps_c.h"
...
using _Velocities__ros_msg_type = capella_ros_msg__msg__Velocities;
...
size_t get_serialized_size_capella_ros_msg__msg__Velocities(
  const void * untyped_ros_message,
...
static uint32_t _Velocities__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_capella_ros_msg__msg__Velocities(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_capella_ros_msg
size_t max_serialized_size_capella_ros_msg__msg__Velocities(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Velocities__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_capella_ros_msg__msg__Velocities(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_msg, msg, Velocities)() {
