...
#include "capella_ros_msg/msg/detail/pid__rosidl_typesupport_fastrtps_c.h"
...
using _PID__ros_msg_type = capella_ros_msg__msg__PID;
...
static uint32_t _PID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_capella_ros_msg__msg__PID(
...
static size_t _PID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_capella_ros_msg__msg__PID(
