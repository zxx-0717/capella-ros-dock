...
#include "capella_ros_msg/msg/detail/battery__rosidl_typesupport_fastrtps_c.h"
...
using _Battery__ros_msg_type = capella_ros_msg__msg__Battery;
...
size_t get_serialized_size_capella_ros_msg__msg__Battery(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name res_cap
  {
    size_t item_size = sizeof(ros_message->res_cap);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Battery__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_capella_ros_msg__msg__Battery(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_capella_ros_msg
size_t max_serialized_size_capella_ros_msg__msg__Battery(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Battery__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_capella_ros_msg__msg__Battery(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, capella_ros_msg, msg, Battery)() {
