...
bool capella_ros_msg__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("capella_ros_msg.msg._imu.Imu", full_classname_dest, 28) == 0);
  }
  capella_ros_msg__msg__Imu * ros_message = _ros_message;
  {  // linear_acceleration
...
PyObject * capella_ros_msg__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("capella_ros_msg.msg._imu");
