...
{
  new (message_memory) capella_ros_msg::msg::Velocities(_init);
}

void Velocities_fini_function(void * message_memory)
{
  auto typed_message = static_cast<capella_ros_msg::msg::Velocities *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Velocities_message_member_array[3] = {
  {
    ...
    offsetof(capella_ros_msg::msg::Velocities, linear_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::Velocities, linear_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::Velocities, angular_z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Velocities_message_members = {
  ...
  3,  // number of fields
  sizeof(capella_ros_msg::msg::Velocities),
...
get_message_type_support_handle<capella_ros_msg::msg::Velocities>()
{
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::Velocities_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, capella_ros_msg, msg, Velocities)() {
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::Velocities_message_type_support_handle;
}
