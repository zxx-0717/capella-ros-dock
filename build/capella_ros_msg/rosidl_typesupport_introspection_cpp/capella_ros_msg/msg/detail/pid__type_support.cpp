...
{
  new (message_memory) capella_ros_msg::msg::PID(_init);
}

void PID_fini_function(void * message_memory)
{
  auto typed_message = static_cast<capella_ros_msg::msg::PID *>(message_memory);
  typed_message->~PID();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PID_message_member_array[3] = {
  {
    ...
    offsetof(capella_ros_msg::msg::PID, p),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::PID, d),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::PID, i),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PID_message_members = {
  ...
  "PID",  // message name
  3,  // number of fields
  sizeof(capella_ros_msg::msg::PID),
...
get_message_type_support_handle<capella_ros_msg::msg::PID>()
{
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::PID_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, capella_ros_msg, msg, PID)() {
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::PID_message_type_support_handle;
}
