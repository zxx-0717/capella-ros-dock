...
{
  new (message_memory) capella_ros_msg::msg::Imu(_init);
}

void Imu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<capella_ros_msg::msg::Imu *>(message_memory);
  typed_message->~Imu();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Imu_message_member_array[3] = {
  {
    ...
    offsetof(capella_ros_msg::msg::Imu, linear_acceleration),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::Imu, angular_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(capella_ros_msg::msg::Imu, magnetic_field),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Imu_message_members = {
  ...
  "Imu",  // message name
  3,  // number of fields
  sizeof(capella_ros_msg::msg::Imu),
...
{
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, capella_ros_msg, msg, Imu)() {
  return &::capella_ros_msg::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
