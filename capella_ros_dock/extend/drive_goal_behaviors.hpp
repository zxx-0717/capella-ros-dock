...
#ifndef CAPELLA_ROS_DOCK__DRIVE_GOAL_BEHAVIORS_HPP_
#define CAPELLA_ROS_DOCK__DRIVE_GOAL_BEHAVIORS_HPP_
...
#include "capella_ros_dock_msgs/action/drive_arc.hpp"
#include "capella_ros_dock_msgs/action/drive_distance.hpp"
#include "capella_ros_dock_msgs/action/navigate_to_position.hpp"
#include "capella_ros_dock_msgs/action/rotate_angle.hpp"
...
private:
    ...
    const RobotState & current_state)
  {
    ...
    for (const auto & hazard : current_state.hazards.detections) {
      if (hazard.type == capella_ros_dock_msgs::msg::HazardDetection::CLIFF) {
        RCLCPP_INFO(logger_, "%s encountered cliff, abort", server_name_.c_str());
        fail_condition = true;
      } else if (hazard.type == capella_ros_dock_msgs::msg::HazardDetection::STALL) {
 ...
 */
class DriveArcBehavior : public DriveGoalBaseBehavior<capella_ros_dock_msgs::action::DriveArc>
{
public:
  DriveArcBehavior(
    rclcpp::node_interfaces::NodeBaseInterface::SharedPtr node_base_interface,
  ...
  void initialize_goal(const capella_ros_dock_msgs::action::DriveArc::Goal & goal) override;
  bool iterate_on_goal(
    const tf2::Transform & current_pose,
    BehaviorsScheduler::optional_output_t & output) override;
  std::shared_ptr<capella_ros_dock_msgs::action::DriveArc::Feedback> get_feedback(
...
class DriveDistanceBehavior
  : public DriveGoalBaseBehavior<capella_ros_dock_msgs::action::DriveDistance>
{
public:
  ...
  void initialize_goal(const capella_ros_dock_msgs::action::DriveDistance::Goal & goal) override;
  bool iterate_on_goal(
    const tf2::Transform & current_pose,
    BehaviorsScheduler::optional_output_t & output) override;
  std::shared_ptr<capella_ros_dock_msgs::action::DriveDistance::Feedback> get_feedback(
    const rclcpp::Duration & time_since_feedback) override;
 ...
 */
class RotateAngleBehavior : public DriveGoalBaseBehavior<capella_ros_dock_msgs::action::RotateAngle>
{
public:
  RotateAngleBehavior(
    rclcpp::node_interfaces::NodeBaseInterface::SharedPtr node_base_interface,
  ...
  void initialize_goal(const capella_ros_dock_msgs::action::RotateAngle::Goal & goal) override;
  bool iterate_on_goal(
    const tf2::Transform & current_pose,
    BehaviorsScheduler::optional_output_t & output) override;
  std::shared_ptr<capella_ros_dock_msgs::action::RotateAngle::Feedback> get_feedback(
    const rclcpp::Duration & time_since_feedback) override;
...
class NavigateToPositionBehavior
  : public DriveGoalBaseBehavior<capella_ros_dock_msgs::action::NavigateToPosition>
{
public:
  ...
  void initialize_goal(const capella_ros_dock_msgs::action::NavigateToPosition::Goal & goal) override;
  bool iterate_on_goal(
    const tf2::Transform & current_pose,
    BehaviorsScheduler::optional_output_t & output) override;
  std::shared_ptr<capella_ros_dock_msgs::action::NavigateToPosition::Feedback> get_feedback(
    const rclcpp::Duration & time_since_feedback) override;
...
private:
  ...
  capella_ros_dock_msgs::action::NavigateToPosition::Goal nav_goal_;
  capella_ros_dock_msgs::action::NavigateToPosition::Feedback nav_state_;
  int8_t last_reported_nav_state_;
};

}  // namespace capella_ros_dock
#endif  // CAPELLA_ROS_DOCK__DRIVE_GOAL_BEHAVIORS_HPP_
