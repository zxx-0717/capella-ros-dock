...
#include "capella_ros_dock/motion_control_node_backup.hpp"
  ...
  repeat_print_(1s)
{
  ...
  // Services
  power_server_ = this->create_service<capella_ros_dock_msgs::srv::RobotPower>(
    "robot_power",
    std::bind(
      &MotionControlNode::power_off_request, this, std::placeholders::_1,
      std::placeholders::_2));
  e_stop_server_ = this->create_service<capella_ros_dock_msgs::srv::EStop>(
    "e_stop",
    std::bind(
  ...
  hazard_detection_sub_ =
    this->create_subscription<capella_ros_dock_msgs::msg::HazardDetectionVector>(
    "hazard_detection",
  ...
  kidnap_sub_ = this->create_subscription<capella_ros_dock_msgs::msg::KidnapStatus>(
  ...
  backup_limit_hazard_pub_ = this->create_publisher<capella_ros_dock_msgs::msg::HazardDetection>(
    "_internal/backup_limit", rclcpp::SensorDataQoS().reliable());

  wheel_status_pub_ = this->create_publisher<capella_ros_dock_msgs::msg::WheelStatus>(
...
void MotionControlNode::control_robot()
{
  ...
  auto wheel_status_msg = std::make_unique<capella_ros_dock_msgs::msg::WheelStatus>();
...
void MotionControlNode::check_backup_buffer()
{
  if (backup_buffer_low_) {
    auto backup_limit_msg = std::make_unique<capella_ros_dock_msgs::msg::HazardDetection>();
    backup_limit_msg->header.frame_id = base_frame_;
    backup_limit_msg->header.stamp = this->now();
    backup_limit_msg->type = capella_ros_dock_msgs::msg::HazardDetection::BACKUP_LIMIT;
...
void MotionControlNode::hazard_vector_callback(
  capella_ros_dock_msgs::msg::HazardDetectionVector::ConstSharedPtr msg)
{
  const std::lock_guard<std::mutex> lock(current_state_mutex_);
...
void MotionControlNode::kidnap_callback(capella_ros_dock_msgs::msg::KidnapStatus::ConstSharedPtr msg)
{
...
void MotionControlNode::e_stop_request(
  const capella_ros_dock_msgs::srv::EStop::Request::SharedPtr request,
  capella_ros_dock_msgs::srv::EStop::Response::SharedPtr response)
{
...
void MotionControlNode::power_off_request(
  const capella_ros_dock_msgs::srv::RobotPower::Request::SharedPtr request,
  capella_ros_dock_msgs::srv::RobotPower::Response::SharedPtr response)
{
  auto set_response_w_msg = [this, response](const std::string msg, ResponseStatus result) {
      response->message = msg;
      response->success = static_cast<bool>(result);
