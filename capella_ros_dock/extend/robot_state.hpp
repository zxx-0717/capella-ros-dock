...
#ifndef CAPELLA_ROS_DOCK__ROBOT_STATE_HPP_
#define CAPELLA_ROS_DOCK__ROBOT_STATE_HPP_
...
#include "capella_ros_dock_msgs/msg/dock_status.hpp"
#include "capella_ros_dock_msgs/msg/hazard_detection.hpp"
#include "capella_ros_dock_msgs/msg/hazard_detection_vector.hpp"
#include "capella_ros_dock_msgs/msg/stop_status.hpp"
#include "capella_ros_dock_msgs/msg/wheel_vels.hpp"
...
private:
  // Callback functions
  void dock_callback(capella_ros_dock_msgs::msg::DockStatus::SharedPtr msg);
  ...
  rclcpp::Publisher<capella_ros_dock_msgs::msg::StopStatus>::SharedPtr stop_status_publisher_{nullptr};

  // Subscribers
  rclcpp::Subscription<capella_ros_dock_msgs::msg::DockStatus>::SharedPtr dock_subscription_;
  ...
  capella_ros_dock_msgs::msg::StopStatus stop_status_msg_;
...
#endif  // CAPELLA_ROS_DOCK__ROBOT_STATE_HPP_
