...
#include "capella_ros_dock/robot_state.hpp"
...
: rclcpp::Node("robot_state", options)
{
  ...
  dock_subscription_ = create_subscription<capella_ros_dock_msgs::msg::DockStatus>(
  ...
  stop_status_publisher_ = create_publisher<capella_ros_dock_msgs::msg::StopStatus>(
...
void RobotState::dock_callback(capella_ros_dock_msgs::msg::DockStatus::SharedPtr msg)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(capella_ros_dock::RobotState)
