...
#include "capella_ros_dock_msgs/msg/kidnap_status.hpp"
#include "capella_ros_dock_msgs/msg/hazard_detection.hpp"
#include "capella_ros_dock_msgs/msg/wheel_status.hpp"
#include "capella_ros_dock_msgs/srv/e_stop.hpp"
#include "capella_ros_dock_msgs/srv/robot_power.hpp"
#include "capella_ros_dock/docking_behavior.hpp"
#include "capella_ros_dock/drive_goal_behaviors.hpp"
#include "capella_ros_dock/reflex_behavior.hpp"
#include "capella_ros_dock/wall_follow_behavior.hpp"
...
private:
  ...
  void kidnap_callback(capella_ros_dock_msgs::msg::KidnapStatus::ConstSharedPtr msg);
  ...
  rclcpp::Service<capella_ros_dock_msgs::srv::RobotPower>::SharedPtr power_server_;
  /// \brief Service to e_stop robot, this will prevent robot from commanding velocity
  rclcpp::Service<capella_ros_dock_msgs::srv::EStop>::SharedPtr e_stop_server_;

  rclcpp::Subscription<capella_ros_dock_msgs::msg::HazardDetectionVector>::SharedPtr
  ...
  rclcpp::Subscription<capella_ros_dock_msgs::msg::KidnapStatus>::SharedPtr kidnap_sub_;
  rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_out_pub_;
  rclcpp::Publisher<capella_ros_dock_msgs::msg::HazardDetection>::SharedPtr backup_limit_hazard_pub_;
  rclcpp::Publisher<capella_ros_dock_msgs::msg::WheelStatus>::SharedPtr wheel_status_pub_;
