...
#ifndef CAPELLA_ROS_DOCK__REFLEX_BEHAVIOR_HPP_
#define CAPELLA_ROS_DOCK__REFLEX_BEHAVIOR_HPP_
...
private:
  ...
  const std::map<std::string, uint8_t> reflex_names_to_hazard_ {
    {"REFLEX_BUMP", capella_ros_dock_msgs::msg::HazardDetection::BUMP},
    {"REFLEX_CLIFF", capella_ros_dock_msgs::msg::HazardDetection::CLIFF},
    ...
    {"REFLEX_STUCK", capella_ros_dock_msgs::msg::HazardDetection::STALL},
    {"REFLEX_VIRTUAL_WALL", std::numeric_limits<uint8_t>::max()},
    {"REFLEX_WHEEL_DROP", capella_ros_dock_msgs::msg::HazardDetection::WHEEL_DROP}};
  ...
  std::map<uint8_t, bool> hazard_reflex_enabled_ {
    {capella_ros_dock_msgs::msg::HazardDetection::BUMP, true},
    {capella_ros_dock_msgs::msg::HazardDetection::CLIFF, true},
    {capella_ros_dock_msgs::msg::HazardDetection::STALL, true},
    {capella_ros_dock_msgs::msg::HazardDetection::WHEEL_DROP, true}};
  ...
  boost::optional<tf2::Vector3> get_pose_relative_to_odom(
    const capella_ros_dock_msgs::msg::HazardDetection & hazard);
  ...
  std::vector<capella_ros_dock_msgs::msg::HazardDetection> last_hazards_;
  std::vector<capella_ros_dock_msgs::msg::HazardDetection> last_trigger_hazards_;
...
#endif  // CAPELLA_ROS_DOCK__REFLEX_BEHAVIOR_HPP_
