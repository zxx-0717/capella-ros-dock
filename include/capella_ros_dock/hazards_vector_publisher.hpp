...
#include "capella_ros_service_interfaces/msg/hazard_detection.hpp"
#include "capella_ros_service_interfaces/msg/hazard_detection_vector.hpp"
...
private:
  ...
  rclcpp::Publisher<capella_ros_service_interfaces::msg::HazardDetectionVector>::SharedPtr publisher_;

  // Vector of subscriptions
  using HazardVectorSubscriptionPtr =
    std::vector<rclcpp::Subscription<capella_ros_service_interfaces::msg::HazardDetection>::SharedPtr>;
  ...
  capella_ros_service_interfaces::msg::HazardDetectionVector msg_;
};
